...
public final class PitchConstants {
    ...
    public static final Color player3 = Color.rgb(71, 255, 236);
    public static final Color player4 = Color.rgb(71, 255, 150);
    public static final Color textColor = Color.rgb(255,255,255);
    public static final String sideBarStyle = "-fx-background-image: url('/Assets/sidebar.jpg');-fx-background-size: cover; -fx-border-color: red; -fx-border-style: solid; -fx-border-width: 3px; -fx-border-radius: 2px 0px 0px 2px;";
}
